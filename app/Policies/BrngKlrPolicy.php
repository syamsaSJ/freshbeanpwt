...
class BrngKlrPolicy
{
     ...
     */
    public function view(User $user, BrngKlr $brngKlr): bool
    {
     ...
     */
    public function update(User $user, BrngKlr $brngKlr): bool
    {
     ...
     */
    public function delete(User $user, BrngKlr $brngKlr): bool
    {
     ...
     */
    public function forceDelete(User $user, BrngKlr $brngKlr): bool
    {
     ...
     */
    public function restore(User $user, BrngKlr $brngKlr): bool
    {
     ...
     */
    public function replicate(User $user, BrngKlr $brngKlr): bool
    {
