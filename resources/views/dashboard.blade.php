<x-app-layout>
    <style>
        ...
        @media (max-width: 480px) {
            ...
            /* Tambahan untuk gambar pada .product-card dan .product-card-me */
            .product-card img,
            .product-card-me img {
                width: 100%;
                /* Make sure images fit their container */
                height: auto;
                /* Maintain the aspect ratio */
                max-width: 100%;
                max-height: 150px;
                /* Set a maximum height to prevent oversized images */
                object-fit: cover;
                /* Ensure the image is properly cropped and scaled */
            }
        }
    </style>
    ...
    <section class="section" id="section">
        ...
        <div class="products">
            @foreach($rekomendasiProduks->take(6) as $index => $rekomendasiProduk)
                <div class="product-card dark:bg-gray-500">
    ...
    <section class="section">
        ...
        <div class="productsme">
            @foreach($products->take(10) as $product)
                <div class="product-card-me dark:bg-gray-500">
